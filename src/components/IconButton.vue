...
export type IconName = 'edit' | 'settings';
...
<template>
  <button
    ...
    :class="active ? 'text-amber-400 bg-slate-700' : 'text-slate-400 hover:text-white'"
  >
    <svg
      ...
      class="w-5 h-5"
    >
      <path stroke-linecap="round" stroke-linejoin="round" :d="icons[props.icon]" />
    </svg>
  </button>
</template>
