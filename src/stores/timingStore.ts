...
import { generateId, nowMs, averageLapMs, fastestLap } from '@/utils/timing'
...
export const useTimingStore = defineStore('timing', () => {
  ...
  function recordFinish(
    ...
    const finishEvent = recordEvent('RUNNER_FINISH', sessionId, runnerId, state.currentIntervalId, ts)
